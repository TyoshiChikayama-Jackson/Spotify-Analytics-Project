...
2. If your GitHub repo name differs from `spotify-analytics-dashboard`, update `base` in [vite.config.js](vite.config.js) and `homepage` in [package.json](package.json) to match.
